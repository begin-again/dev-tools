...
describe('Engine Module', () => {
    ...
    describe('satisfyingVersions()', () => {
        ...
        it('should be empty array when nothing satisfies due to an error', () => {
            const stub = sinon.stub(engine, 'properNodeVersions');
        ...
        it('should find 2 matches sorted desc', () => {
            const stub = sinon.stub(engine, 'properNodeVersions');
            engine.versions = [
                { version: 'v10.12.13' }
                , { version: 'v12.12.13' }
        ...
        it('should find 2 matches sorted desc via default', () => {
            engine.versions = [
                { version: 'v10.12.13' }
                , { version: 'v12.12.13' }
                , { version: 'v12.19.0' }
        ...
        it('should find 2 matches sorted desc via default when engines.versions not defined', () => {
            const versions = [
                { version: 'v10.12.13' }
                , { version: 'v12.12.13' }
                , { version: 'v12.19.0' }
        ...
        it('should work with major versions', () => {
            const versions = [
                { version: 'v10.12.13' }
                , { version: 'v12.12.13' }
                , { version: 'v12.19.0' }
    ...
    describe('repositoryEngines()', () => {
        ...
        it('should return default there is not a node property', () => {
    ...
    describe('versionToUseValidator()', () => {
        ...
        describe('user specified version', () => {
            ...
            it('should pick 16.13.0 -- issue 116', () => {
        ...
        describe('default', () => {
            ...
            it('should throw when version not specified and not installed versions satisfy', () => {
                sinon.stub(engine, 'repositoryEngines').callsFake(() => '^8.11.1 || ^10.13.0 || ^12.13.0');
            ...
            it('should be 12.11.1 when oldest not specified', () => {
                sinon.stub(engine, 'repositoryEngines').callsFake(() => '^8.11.1 || ^10.13.0 || ^12.13.0');
            ...
            it('should be 12.11.1 when oldest is true', () => {
                sinon.stub(engine, 'repositoryEngines').callsFake(() => '^8.11.1 || ^10.13.0 || ^12.13.0');
    ...
    describe('versionStringToObject()', () => {
